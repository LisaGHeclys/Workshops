  ...
  return (
    ...
    >
      <div className="flex-row space-y-5">
        ...
        <h2 className="text-xl font-normal">{competence.Description}</h2>
      </div>
    ...
    <>
      <div className="grid place-items-center h-screen">
        <div className="grid grid-row-4 w-3/4 h-2/3">
          <h1 className="row-span-1 text-5xl font-semibold">What I Do</h1>
          <div className="row-span-2 flex justify-self-center align-center justify-center space-x-8">
            {competences.map((competence, index) => {
              return <CompetencesCard competence={competence} key={index} />;
            })}
          </div>
      ...
      <div className="grid place-items-center h-screen">
        <div className="grid grid-row-8 w-3/4 h-2/3">
          <h1 className="row-span-1 text-5xl font-semibold">Portfolio</h1>
        </div>
      </div>
    </>
  );
