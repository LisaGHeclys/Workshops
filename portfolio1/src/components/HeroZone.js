...
function HeroZone() {
  ...
  return (
    <>
      <Header />
      <div className="grid place-items-center h-screen pt-10">
        <div className="grid grid-row-6 grid-cols-2 gap-2 w-3/4 h-2/3 space-x-10">
          <div className="flex flex-col space-y-5 text-left">
            <h1 className="text-2xl font-bold">__ Hello</h1>
            <h1 className="text-6xl font-medium">
              I'm <h1 className="inline-block font-bold">Sarah Jackson</h1>
            </h1>
            ...
            <h1 className="text-xl font-normal">
              Of course, there’s so much more to me than just a few fancy
              titles. Scroll down and get to know me,
            </h1>
          </div>
